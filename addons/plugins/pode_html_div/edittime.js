function GetPluginSettings() {
  return {
    ...
    version: "1.5",
    description:
      "Gives you a full featured HTML Div to play with! Display text, widgets or even video in your games and apps!",
    author: "Jesse Johnston, mod. JP Deblonde",
    "help url": "http://www.metaformed.com",
    category: "Web",
    type: "world", // appears in layout
    rotatable: true,
    flags: pf_position_aces | pf_size_aces | pf_angle_aces | pf_zorder_aces,
  };
}
...
AddCondition(
  ...
  "HTML Div",
  "innerHTML is <i>{0}</i>",
  "Compare the innerHTML currently displayed in the Div.",
  "CompareinnerHTML"
);
...
AddCondition(
  ...
  "HTML Div",
  "CSS Style is <i>{0}</i>",
  "Compare the CSS style currently displayed in the Div.",
  "CompareStyle"
);
...
AddCondition(
  ...
  "HTML Div",
  "On load completed",
  "Triggered when content loading completes successfully.",
  "OnComplete"
);
...
AddCondition(
  ...
  "HTML Div",
  "On load error",
  "Triggered when an content loading fails.",
  "OnError"
);
...
AddAction(
  ...
  "HTML Div",
  "Set innerHTML to {0}",
  "Set the div's content (HTML Allowed).",
  "SetInnerHTML"
);

AddStringParam(
  "CSS Styling",
  "The CSS style to apply to this div (eg. font-size:10px;font-family:arial; ) ."
);
AddAction(
  1,
  af_none,
  "Set CSS Styling",
  "HTML Div",
  "Set div CSS Style to {0}",
  "Set the div's CSS Style.",
  "SetStyle"
);
...
AddStringParam(
  "POST Data (Optional)",
  "The post data to pass to the URL (eg. name=fred&&id=5 )"
);
AddAction(
  2,
  af_none,
  "Load Content",
  "HTML Div",
  "Load content from page <b>{0}</b>",
  "Load content into the div from another page.",
  "LoadDiv"
);
...
var property_list = [
  new cr.Property(
    ...
    "Initial visibility",
    "Visible",
    "Choose whether the Div is visible on startup.",
    "Invisible|Visible"
  ),
...
IDEInstance.prototype.Draw = function (renderer) {
  if (!this.font) this.font = renderer.CreateFont("Arial", 14, false, false);
  ...
  if (this.properties["innerHTML"].length) {
    ...
    this.font.DrawText("Empty Div", rc, cr.RGB(128, 128, 128), ha_left);
  }
};

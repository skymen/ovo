...
AddExpression(5,	ef_return_number,	"Get line height",	"Text",			"LineHeight", "Get the height of the line in pixels.");

AddExpression(6,	ef_return_number,	"Get Horizontal Alignment",	"Appearance",			"HAlign", "Get the Horizontal Alignment.");
AddExpression(7,	ef_return_number,	"Get Vertical Alignment",	"Appearance",			"VAlign", "Get the Vertical Alignment.");
...
var property_list = [
	...
	new cr.Property(ept_combo,		"Clamp alignment", "Yes", "Horizontal alignment of the text.", "Yes|No"),
...
IDEInstance.prototype.Draw = function(renderer)
{
	...
	if (this.font)
	{
		...
		var halign = (ha_left + ha_right) * hprop ;
		var valign = (va_top + va_bottom) * vprop ;

...
AddComboParamOption("No");
AddComboParamOption("Yes");
AddComboParam("Absolute", "Set absolute mode.", 0);
AddAction(16, 0, "Set absolute", "Setting",
    "Set {my} absolute to <i>{0}</i>",
...
AddExpression(13, ef_return_number, "Get x offset", "Absolute", "OffX", 
              "The x offset in absolute mode.");                   
AddExpression(14, ef_return_number, "Get y offset", "Absolute", "OffY",
              "The y offset in absolute mode.");                  
AddExpression(15, ef_return_number, "Get angle offset", "Absolute", "OffAngle",
              "The angle offset in absolute mode.");             
...
var property_list = [
    ...
    new cr.Property(ept_combo, "Absolute mode", "No", "If set to yes, no movement will be done and instead it will send the offset values as expressions", "No|Yes"),        
	];

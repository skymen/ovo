...
{
	return {
		"name":			"Skymen Pin",					// as appears in 'add behavior' dialog, can be changed as long as "id" stays the same
		"id":			"SkymenPin",					// this is used to identify this behavior and is saved to the project; never change it
		"version":      "1.1",
...
var property_list = [
		new cr.Property(ept_combo, "Update mode", "After Events (default)", "Basically defines wether the pin should update before the events run of after.", "Before Events|After Events (default)")
	];

...
AddCondition(2, cf_none, "Is Enabled", "", "{my} is enabled", "True if the button is currently enabled.", "IsEnabled");
...
AddAction(0, 0, "Set enabled", "", "Set {my} to <i>{0}</i>","Enable/Disable the button.", "setEnabled");
...
var property_list = [
	...
	new cr.Property(ept_text, "Hover Frame", "","The hover frame."),
	new cr.Property(ept_text, "Clicked Frame", "","The clicked frame."),
	new cr.Property(ept_text, "Disabled Frame", "","The disabled frame."),
